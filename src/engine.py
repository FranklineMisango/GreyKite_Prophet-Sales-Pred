...
if val == 0:
    ...
    # Replacing the outliers in target variable
    ...
    # Selecting specific features in dataset 
    ...
    print('Neural Prophet model is saved as pkl file in '+str('../output/prophet_model.pkl'))
